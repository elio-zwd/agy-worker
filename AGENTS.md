...
这是 Windows 10 x64 的本地 AGY Worker，Python 3.13、官方 MCP Python SDK，对外提供能力发现、五个任务级 MCP 工具及两个只读资源。Codex 侧 stdio Server 是一次性 Bridge；常驻 Controller 唯一持有 Runtime 与 runtime.lock。
